...
import com.kuldip.chatzapp.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.continueBtn.setOnClickListener {
            if ((binding.userName.text!!.isEmpty()) || (binding.detail.text!!.isEmpty())){
    ...
    private fun uploadInfo(imgUrl: String) {
        val user = UserModel(auth.uid.toString(), binding.userName.text.toString(),binding.detail.text.toString(),
